...
export default function InvoicesAdmin() {
  ...
  const rowActions = [
    { label: 'View', icon: <FileTextOutlined />, onClick: (row) => console.log('View', row), showInMenu: true },
    { label: 'Download', icon: <FileTextOutlined />, onClick: (row) => console.log('Download', row), showInMenu: true },
    { label: 'Print', icon: <FileTextOutlined />, onClick: (row) => console.log('Print', row), showInMenu: true },
    { label: 'Share', icon: <FileTextOutlined />, onClick: (row) => console.log('Share', row), showInMenu: true },
  ];
      ...
      <Grid item xs={12}>
        <Stack direction="row" justifyContent="space-between" alignItems="flex-end">
          <Box>
            ...
            <Typography variant="body2" color="textSecondary">Manage system generated invoices.</Typography>
          </Box>
        </Stack>
      </Grid>
