  ...
  return (
    <div className="space-y-6 font-body">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e0e0e0] pb-4">
        ...
        <button onClick={onCreateOrder} className="px-4 py-1.5 text-xs font-bold bg-[#0f62fe] text-white hover:bg-[#0043ce] cursor-pointer">
          + Create New Order
        </button>
      </div>
      ...
      <div className="bg-white p-4 border border-[#e0e0e0] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-1 items-center gap-3">
          <div className="relative flex-1 max-w-sm">
            <input
              ...
              className="w-full px-3 py-1.5 bg-[#f4f4f4] border border-[#e0e0e0] text-xs text-[#161616] focus:outline-none focus:border-[#0f62fe]"
            />
          </div>
        ...
        <button
          ...
          className="px-3 py-1 text-xs font-semibold border border-[#0f62fe] text-[#0f62fe] bg-white hover:bg-[#edf5ff] cursor-pointer"
        >
          Export Excel
        </button>
      </div>
