...
import type { Product } from '../../types/stitchTypes';
    ...
    <div className="space-y-6 font-body text-xs">
      ...
      <div className="bg-white p-3 border border-[#e0e0e0] flex flex-col md:flex-row justify-between gap-3">
        <input
          ...
          className="flex-1 px-3 py-1.5 bg-[#f4f4f4] border border-[#e0e0e0] text-xs text-[#161616] focus:outline-none focus:border-[#0f62fe]"
        />
